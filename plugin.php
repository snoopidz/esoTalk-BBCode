...
public function handler_conversationController_getEditControls($sender, &$controls, $id)
{
    ...
    addToArrayString($controls, "center", "<a href='javascript:BBCode.center(\"$id\");void(0)' title='".T("Center")."' class='bbcode-center'><i class='icon-align-center'></i></a>", 0);
	...
	addToArrayString($controls, "underline", "<a href='javascript:BBCode.underline(\"$id\");void(0)' title='".T("Underline")."' class='bbcode-u'><i class='icon-underline'></i></a>", 0);
